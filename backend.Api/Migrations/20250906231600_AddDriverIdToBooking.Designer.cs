...
namespace backend.Api.Migrations
{
    ...
    [Migration("20250906231600_AddDriverIdToBooking")]
    partial class AddDriverIdToBooking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Entities.RideRequest", b =>
                {
                    ...
                    b.HasOne("API.Entities.User", "Passenger")
                        .WithMany()
                        .HasForeignKey("PassengerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.Tenant", "TenantName")
                        .WithMany("RideRequests")
                        .HasForeignKey("TenantNameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
